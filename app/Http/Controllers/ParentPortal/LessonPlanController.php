 ...
 * Phase 4 resources and all three portals. No store() — parents never
 * author lesson plans.
 */
class LessonPlanController extends Controller
{
    ...
    public function index(Request $request, ScopeService $scope): View
    {
        ...
        return view('parent.lesson-plans.index', ['lessonPlans' => $lessonPlans]);
    }
    ...
    public function show(Request $request, ScopeService $scope, int $lessonPlan): View
    {
        ...
        return view('parent.lesson-plans.show', ['lessonPlan' => $resolved]);
    }
}

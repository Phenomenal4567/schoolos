 ...
 * for an assessment whose due_date is a few days away and still carries
 * a balance. database channel only, same reasoning as
 * AttendanceAbsenceNotification.
 */
class FeeDeadlineUpcomingNotification extends Notification
{

...
@section('content')
    ...
    @if ($slots->isEmpty())
        <x-empty-state
            ...
            description="Your timetable will appear here once slots are scheduled."
        />
    @else
                            ...
                            @foreach ($grouped->get($day)->sortBy('period_number') as $slot)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-right">
                                        <a href="{{ route('student.timetable.show', $slot) }}" class="text-indigo-600 hover:text-indigo-500">
                                            View
                                        </a>
                                    </td>
                                </tr>

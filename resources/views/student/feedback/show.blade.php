...
@section('content')
    <a href="{{ route('student.feedback.index') }}" class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700">
    ...
    <x-card>
        ...
        <p class="mt-1 text-xs text-gray-500">{{ $feedback->created_at?->format('M j, Y g:ia') }}</p>

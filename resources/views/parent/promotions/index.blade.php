...
@section('content')
    @if ($promotions->isEmpty())
        <x-empty-state
            ...
            description="Your child's end-of-year promotion decision will appear here once recorded."
        />
    @else
        <div class="space-y-2">
            @foreach ($promotions as $promotion)
                <a
                    href="{{ route('parent.promotions.show', $promotion) }}"
                ...
                >
                    <div class="min-w-0">
                        ...
                        <p class="mt-0.5 text-xs text-gray-500">
                            ...
                            &middot; {{ ucfirst($promotion->method) }}
